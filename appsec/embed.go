...
// StaticRecommendedRules holds the recommended AppSec security rules (v1.12.0)
// Source: https://github.com/DataDog/appsec-event-rules/blob/1.12.0/build/recommended.json
//
//go:embed rules.json
